...
image = PIL.Image.open('Netflix.png')
...
# next button and increment our index tracker (next_clicked)
    ...
    # go back to the beginning i.e. homepage

# create your radio button with the index that we loaded
choice = st.sidebar.radio("go to",('Home', 'Contact Us'))
...
if choice == 'Home':
    ...
    st.header('NETFLIX CLONE')
    st.write('Visit our webpage :https://help.netflix.com/en/')
